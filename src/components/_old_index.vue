...
import { forEach, pick, throttle } from 'lodash-es'
import { onClickOutside, unrefElement, useScroll, useWindowScroll } from '@vueuse/core'
  ...
  <div ref="container" class="relative overflow-y-auto" @scroll="onContainerScroll">
    ...
    <div>
      <table class="w-auto table-fixed border-collapse text-center bg-white relative">
        ...
        <tbody>
          <tr v-for="(row, y) in dataSource" :key="y">
            <td
